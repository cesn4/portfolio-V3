...
export const portfolio = {
    title: "Portfolio",
    summary: "Another practice of creating a little bit different Arcade-AI portfolio application. Project polished knowlage from discovery-app, and increased proficiency of React Hook control and NPM packages",
    tools: "TypeScript, React, Redux, Sass",
...
export const hantera = {
    title: "Hantera Shop",
    summary: "Project combined from two applications - Shop it's self and CMS. Both created from scratch with React framework and connected with Google FireBase server services.",
...
export const boardScore = {
    title: "Board Score",
    summary: "Spare time start-up activity witch is based on learning and creating an mobile application with Dart programing language, Flutter framework and Firebase servers.",
...
export const grayBoundaries = {
    title: "Gary Boundaries",
    summary: "An Contributaion for project author with help creating a web application for content. Project built with Gatsby framework and GrathQL query language.",
